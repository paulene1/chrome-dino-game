...
let birdX = 700;
let birdY = Math.floor(Math.random()* (100 - 70 + 1)) + 90;
...
const placeCactus = () => {
    ...
    if (placeCactusChance > .90) { //10% chance cactus3 will spawn
        cactus.img = cactus3Img;
        cactus.width = cactus3Width;
        cactusArray.push(cactus);
        spawnCd = 60;
    }
    else if (placeCactusChance > .70){ //30% chance cactus2 will spawn
